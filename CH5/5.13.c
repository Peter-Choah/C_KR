 ...
 * no matter how unreasonable the input or the value of n. Write the program so
 * it makes the best use of available storage; lines should be stored as in the
